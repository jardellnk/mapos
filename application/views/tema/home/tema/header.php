            ...
            <a class="navbar-brand wow fadeIn" href="<?php echo base_url('index.php/home'); ?>">
                ...
                <div class="collapse navbar-collapse" id="navbarNavDropdown">
                    <ul class="navbar-nav ml-auto mr-auto wow fadeIn">
                        <li class="nav-item">
                            <a href="<?php echo base_url('home/produtos?pagina=1'); ?>" class="nav-link"><b>Produtos</b></a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo base_url('#'); ?>" class="nav-link"><b>Computadores</b></a>
                        </li> 
                        <li class="nav-item">
                            <a href="<?php echo base_url('#'); ?>" class="nav-link"><b>FAQ</b></a>
                        </li> 
                        <li class="nav-item">
