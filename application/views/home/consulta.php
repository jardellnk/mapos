                                            ...
                                            <?php if(isset($row['status'])): ?>
                                                ...
                                                <td>
                                                    ...
                                                    if ($status === 'Faturado' && $dentroDoPrazo): ?>
                                                        ...
                                                        <a href="<?= base_url('./arquivos/download/1') ?>" class="btn btn-secondary" title="Baixar Termo de Garantia"><i class="far fa-file-alt"></i></a>
                                                        <a href="<?= base_url('./arquivos/download/1') ?>" class="btn btn-secondary" title="Baixar Drives"><i class="fas fa-download"></i></a>
